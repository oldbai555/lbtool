...
func NewOSS(conf Config) (ossStorage OSSStorage, err error) {
...
func (o OSSStorage) SignURL(objectKey string, method utils.HTTPMethod, expiredInSec int64) (signedURL string, err error) {
...
func (o OSSStorage) GetCredentials() (*Credentials, error) {

	return nil, nil
}

func (o OSSStorage) GetSignature(httpMethod, name, ak, sk string, expired time.Duration) string {

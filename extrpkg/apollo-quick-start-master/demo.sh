...
apollo_config_db_url="jdbc:mysql://xxxxxxxx:3306/ApolloConfigDB?characterEncoding=utf8&serverTimezone=Asia/Shanghai"
apollo_config_db_username=root
apollo_config_db_password=

# apollo portal db info
apollo_portal_db_url="jdbc:mysql://xxxxxxxx:3306/ApolloPortalDB?characterEncoding=utf8&serverTimezone=Asia/Shanghai"
